...
// @LINE:23
private[this] lazy val controllers_Application_newArtist17_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("apaddartist/newArtist"))))
private[this] lazy val controllers_Application_newArtist17_invoker = createInvoker(
controllers.Application.newArtist(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "newArtist", Nil,"POST", """""", Routes.prefix + """apaddartist/newArtist"""))
